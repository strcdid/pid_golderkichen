...
@foreach ($slider as $key=>$nu)
          <div class="item @if($key==0) active @endif" style="background-color: none;">
            <img src="{!! url('/lgarin211.github.io/'.$nu->banner) !!}" width="1920" height="800" alt="Slide" >
            <div class="carousel-caption" style="background-color: rgba(0,0,0,0.75);">
              <div class="container">
                <div class="col-md-8 col-sm-8 col-xs-8">
                  <p>{!! $nu->small_text !!}</p>
                  <h3>{!! $nu->the_tittle !!}</h3>
                  <h6>{!! $nu->small_desription !!}</h6>
                     <a href="{{url('/Contac')}}" title="Get In Touch" >Request Free Quote</a>
                  <br>
                  <hr>
                </div>
              </div>
